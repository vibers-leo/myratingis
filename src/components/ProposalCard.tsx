...
export function ProposalCard({ proposal, type, onClick }: ProposalCardProps) {
  ...
  return (
    <div
      onClick={onClick}
      className="bg-white dark:bg-slate-900 rounded-lg p-6 border border-gray-200 dark:border-slate-700 hover:border-green-600 hover:shadow-md transition-all cursor-pointer"
    >
      {/* 헤더 */}
