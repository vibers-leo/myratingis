      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-xl p-8 md:p-20 shadow-xl shadow-slate-200/50 border border-slate-100 font-sans">
          ...
          <header className="mb-20 text-center">
            <div className="w-20 h-20 bg-slate-100 rounded-lg flex items-center justify-center mx-auto mb-8 shadow-inner">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-20">
            {highlights.map(h => (
              <div key={h.id} className="p-8 rounded-xl bg-slate-50/70 border border-slate-100 hover:bg-white hover:shadow-lg transition-all">
