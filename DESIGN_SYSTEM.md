# 제 평가는요? Design System (v1.0)

제 평가는요?의 디자인 시스템은 **"Clean, Modern, and Premium"**을 핵심 가치로 삼으며, 크리에이터들의 작업을 돋보이게 하는 미니멀하면서도 감각적인 인터페이스를 지향합니다.
...
제 평가는요?는 신뢰감과 창의성을 상징하는 **Green & Mint**를 포인트 컬러로 사용합니다.
...
제 평가는요?는 국문 가독성의 표준인 **Pretendard**를 메인 서체로 사용합니다.
